...
using Belsio.Erp.Application.Identity.Tokens;
using Belsio.Erp.Infrastructure.Auth;
using Belsio.Erp.Infrastructure.Auth.Jwt;
...
internal class TokenService : ITokenService
{
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(BaseClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(BaseClaims.IpAddress, ipAddress),
            new(BaseClaims.Tenant, _currentTenant!.Id),
            new(BaseClaims.ImageUrl, user.ImageUrl ?? string.Empty),
