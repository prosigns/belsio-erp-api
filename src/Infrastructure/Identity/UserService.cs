...
using Belsio.Erp.Application.Common.Exceptions;
using Belsio.Erp.Application.Common.FileStorage;
using Belsio.Erp.Application.Common.Interfaces;
using Belsio.Erp.Application.Common.Mailing;
using Belsio.Erp.Application.Common.Models;
using Belsio.Erp.Application.Common.Specification;
using Belsio.Erp.Application.Identity.Users;
using Belsio.Erp.Domain.Identity;
...
internal partial class UserService : IUserService
{
    ...
    public async Task ToggleStatusAsync(ToggleUserStatusRequest request, CancellationToken cancellationToken)
    {
        ...
        bool isAdmin = await _userManager.IsInRoleAsync(user, BaseRoles.Admin);
        if (isAdmin)
        {
